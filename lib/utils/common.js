...
define(function(require, exports, module) {
	...
	return {
		...
		getNewline: function() {
			...
			var nl = resources.getVariable('newline');
		...
		setNewline: function(str) {
			resources.setVariable('newline', str);
			resources.setVariable('nl', str);
		},
		...
		padString: function(text, pad) {
			var padStr = (_.isNumber(pad)) 
				? this.repeatString(resources.getVariable('indentation') || '\t', pad) 
				: pad;
		...
		replaceVariables: function(str, vars) {
			...
			return tabStops.processText(str, {
