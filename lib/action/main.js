...
define(function(require, exports, module) {
	...
	var actionModules = {
		base64: function() { return require('./base64'); },
		editPoints: function() { return require('./editPoints'); },
		evaluateMath: function() { return require('./evaluateMath'); },
		expandAbbreviation: function() { return require('./expandAbbreviation'); },
		incrementDecrement: function() { return require('./incrementDecrement'); },
		lineBreaks: function() { return require('./lineBreaks'); },
		balance: function() { return require('./balance'); },
		mergeLines: function() { return require('./mergeLines'); },
		reflectCSSValue: function() { return require('./reflectCSSValue'); },
		removeTag: function() { return require('./removeTag'); },
		selectItem: function() { return require('./selectItem'); },
		selectLine: function() { return require('./selectLine'); },
		splitJoinTag: function() { return require('./splitJoinTag'); },
		toggleComment: function() { return require('./toggleComment'); },
		updateImageSize: function() { return require('./updateImageSize'); },
		wrapWithAbbreviation: function() { return require('./wrapWithAbbreviation'); },
		updateTag: function() { return require('./updateTag'); }
	};
	...
	var bind = function(name, method) {
		return function() {
			...
			return m[method].apply(m, arguments);
		};
	};
