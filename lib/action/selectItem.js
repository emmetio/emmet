...
define(function(require, exports, module) {
	...
	function findNextCSSItem(editor) {
		return findItem(editor, false, cssEditTree.extractRule, getRangeForNextItemInCSS);
	}
	
	function findPrevCSSItem(editor) {
		return findItem(editor, true, cssEditTree.extractRule, getRangeForPrevItemInCSS);
	}
	...
	return {
		...
		selectPreviousItemAction: function() {
			if (editor.getSyntax() == 'css') {
