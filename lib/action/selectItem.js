...
define(function(require, exports, module) {
	...
	function findNextCSSItem(editor) {
		return findItem(editor, false, _.bind(cssEditTree.locateRule, cssEditTree), getRangeForNextItemInCSS);
	}
	
	function findPrevCSSItem(editor) {
		return findItem(editor, true, _.bind(cssEditTree.locateRule, cssEditTree), getRangeForPrevItemInCSS);
	}
