...
define(function(require, exports, module) {
	...
	abbreviationParser.addOutputProcessor(function(text, node, type) {
		var maxNum = 0;
		...
		var tsOptions = {
			tabstop: function(data) {
				...
				if (data.placeholder) {
					...
					var placeholder = module.processText(data.placeholder, tsOptions);
		...
		// upgrade tabstops
		text = module.processText(text, tsOptions);
		
		// resolve variables
		text = utils.replaceVariables(text, module.variablesResolver(node));
