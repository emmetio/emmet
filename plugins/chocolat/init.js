...
var keymap = {
	...
	'select_next_item': 'cmd-.',
	'select_previous_item': 'cmd-,',
...
emmet.require('actions').getList().forEach(function(action) {
	...
	Hooks.addMenuItem('Emmet/' + action.options.label, keymap[action.name] || '', function() {
